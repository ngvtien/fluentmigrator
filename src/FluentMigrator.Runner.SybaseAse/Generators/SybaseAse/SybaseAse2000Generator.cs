...
{
    public class SybaseAse2000Generator : GenericGenerator
    {
        public SybaseAse2000Generator()
            : this(new SybaseAse2000Quoter())
        {
        }

        public SybaseAse2000Generator(
            [NotNull] SybaseAse2000Quoter quoter)
        ...
        public SybaseAse2000Generator(
            ...
            : this(new SybaseAse2000Column(new SybaseAse2000TypeMap(), quoter), quoter, new EmptyDescriptionGenerator(), generatorOptions)
        {
        }

        protected SybaseAse2000Generator(
        ...
        public override string Generate(AlterDefaultConstraintExpression expression)
        {
            ...
            builder.AppendFormat("-- create alter table command to create new default constraint as string and run it" + Environment.NewLine +"ALTER TABLE {0} WITH NOCHECK ADD CONSTRAINT {3} DEFAULT({2}) FOR {1};",
                ...
                SybaseAse2000Column.FormatDefaultValue(expression.DefaultValue, Quoter),
                Quoter.QuoteConstraintName(SybaseAse2000Column.GetDefaultConstraintName(expression.TableName, expression.ColumnName)));
        ...
        {
            if (expression.AdditionalFeatures.ContainsKey(SybaseAseExtensions.IdentityInsert))
            {
                return (bool)expression.AdditionalFeatures[SybaseAseExtensions.IdentityInsert];
            }
        ...
        {
            return CompatibilityMode.HandleCompatibilty("Sequences are not supported in SybaseAse2000");
        }
