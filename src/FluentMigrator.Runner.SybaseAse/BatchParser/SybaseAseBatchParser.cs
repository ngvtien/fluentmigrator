...
namespace FluentMigrator.Runner.BatchParser
{
    ...
    /// <see cref="PoundSignSingleLineComment"/>, <see cref="SybaseAseIdentifier"/>, <see cref="SqlString"/>
    /// and the following token searchers: <see cref="GoSearcher"/>.
    /// </remarks>
    public class SybaseAseBatchParser : SqlBatchParser
    {
        [NotNull, ItemNotNull]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SybaseAseBatchParser"/> class.
        /// </summary>
        /// <param name="newLine">The string used to write a new line sequence</param>
        public SybaseAseBatchParser(string newLine = null) : base(_rangeSearchers, _specialTokenSearchers, newLine)
        {
        }
        ...
        protected SybaseAseBatchParser(
